...
![Time Series Plot](:Rplot01.png) {:data-align="center"}
...
![AutoARIMA Forecast](:Rplot02.png) {:data-align="center"}
...
![ARIMA Forecast](:Rplot03.png) {:data-align="center"}  
...
![Time Series Plot](:Rplot04.png) {:data-align="center"} 
...
![Simple Exponential Smoothing Forecast](:Rplot05.png) {:data-align="center"}   
...
![Holt's Method Forecast](:Rplot06.png) {:data-align="center"} 
...
![ETS (AAA Model) Forecast](:Rplot07.png) {:data-align="center"} 
